...
function createApp (argv = {}) {
  ...
  if (localOidcConfig && ldp.auth === 'oidc') {
    ...
    oidcApi.use(bodyParser.json())
    oidcApi.use(bodyParser.urlencoded({ extended: false }))
    app.use('/', oidcApi)
  }
